...
def _seed_config():
    ...
    _set("section_transition_about_color",      "#edf7f2")
    _set("section_transition_hiw_enabled",      "")
    _set("section_transition_hiw_color",        "#edf7f2")
    _set("section_transition_reviews_enabled",  "")
    _set("section_transition_reviews_color",    "#edf7f2")
    _set("section_transition_faq_enabled",      "")
    _set("section_transition_faq_color",        "#edf7f2")
    _set("section_transition_contact_enabled",  "")
    _set("section_transition_contact_color",    "#edf7f2")
    ...
    _set("about_stat_1_value", "100%")
    _set("about_stat_1_label", "Remote services")
    _set("about_stat_2_value", "UK-WIDE")
    _set("about_stat_2_label", "Coverage")
    _set("about_stat_3_value", "FIXED")
    _set("about_stat_3_label", "Transparent pricing")
    _set("about_reviews_stars", "★★★★★")
    _set("about_reviews_label", "Client reviews")
