...
BUSINESS_FIELDS = [
    ...
    ("section_transition_hero_enabled",     "Top Hero Section Transition Enabled", "checkbox", "Enable white to color transition for the top Hero section"),
    ("section_transition_hero_color",       "Top Hero Section Transition Color",   "color",    "End color for the top Hero section transition"),
    ...
    ("section_transition_reviews_enabled",  "Testimonials Transition Enabled",  "checkbox", "Enable white to color transition for Testimonials"),
    ("section_transition_reviews_color",    "Testimonials Transition Color",    "color",    "End color for Testimonials transition"),
    ...
    ("about_stat_1_value", "About Stat 1 Value",   "text",     "Main stat value, e.g. 100%"),
    ("about_stat_1_label", "About Stat 1 Label",   "text",     "Main stat label, e.g. Remote services"),
    ("about_stat_2_value", "About Stat 2 Value",   "text",     "Second stat value, e.g. UK-WIDE"),
    ("about_stat_2_label", "About Stat 2 Label",   "text",     "Second stat label, e.g. Coverage"),
    ("about_stat_3_value", "About Stat 3 Value",   "text",     "Third stat value, e.g. FIXED"),
    ("about_stat_3_label", "About Stat 3 Label",   "text",     "Third stat label, e.g. Transparent pricing"),
    ("about_reviews_stars", "About Reviews Stars", "text",     "Stars text, e.g. ★★★★★"),
    ("about_reviews_label", "About Reviews Label", "text",     "Reviews label, e.g. Client reviews"),
