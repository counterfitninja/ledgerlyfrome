...
BUSINESS_FIELDS = [
    ...
    ("section_transition_hero_enabled",     "Hero Transition Enabled",     "checkbox", "Enable white to color transition for Hero"),
    ("section_transition_hero_color",       "Hero Transition Color",       "color",    "End color for Hero transition"),
